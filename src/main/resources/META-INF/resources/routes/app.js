...
const showProblem = ({solution, scoreExplanation, isSolving}) => {
    ...
    solution.vehicleList.forEach((vehicle) => {
        const {id, capacity, totalDemand, totalDistanceMeters, plate, consumption} = vehicle;
      ...
      <tr>
        ...
        <td>${consumption} KM/L, gasto de ${parseInt(totalDistanceMeters / 1000 / parseInt(consumption))} L</td>
      </tr>`);
    });
